...
This repository provides two standalone Python scripts used to **summarize**, **aggregate**, and **visualize** watermark stability statistics across users, random seeds, datasets, and models **(fig.2, 3, 4, and 6 in the paper)**.
...
## 2. Aggregation and plotting across users (For the first three experiments in the paper (fig.2, 3, 4, and 6), for baseline, refer to the baseline folder)
